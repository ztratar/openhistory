  ...
  return (
    <main className="policy-page">
      <article>
        ...
        <p className="policy-updated">Last updated August 15, 2026</p>
        ...
        <p>The complete policy, uninstall steps, storage layout, and implementation are available in the <a href="https://github.com/ztratar/openhistory/blob/main/PRIVACY.md">public repository</a>.</p>
      </article>
    </main>
  );
}
